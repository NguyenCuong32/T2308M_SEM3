...
namespace EduProjectDemo.Controllers
{
    public class StudentController : Controller
    {
        ...
        {
            var eduDbContext = _context.Students.Include(s => s.Class);
        ...
        public async Task<IActionResult> Create(CreateStudentDto createStudent)
        {
            ...
            ViewData["ClassId"] = new SelectList(_context.Classes, "Id", "Id", createStudent.ClassId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Address,ClassId")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
